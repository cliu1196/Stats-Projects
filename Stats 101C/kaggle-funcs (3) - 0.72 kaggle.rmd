...
# Vary the Threshold (can't get this to work :(

```{r}
#try several threshold values
thresh_vals = seq(0,1,0.01)
wca_vals = rep(0, length(thresh_vals)) #weighted Classification accuracy?
...
#write.csv(predictions, "predictions15.csv", row.names = FALSE)
```